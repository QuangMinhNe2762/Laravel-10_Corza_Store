                ...
                <form action="{{route('products.update',$product->id)}}" method="POST">
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-6">
                      <div class="form-group">
                        <label>Content</label>
                        <textarea class="form-control" id="content"  name="content" rows="3" placeholder="Enter Content">{{$product->content}}</textarea>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <input type="number" name="price_salce" value="{{$product->price_salce}}" class="form-control" placeholder="Enter price sale">
                  </div>
                  <div class="form-group">
